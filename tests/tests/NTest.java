...
public class NTest {
	...
	private static final Semantic Semantic = null;
	    ...
	    public void testCompact() throws NotAPropositionNodeException, NodeNotFoundInNetworkException, IllegalIdentifierException, NodeCannotBeRemovedException, NodeNotFoundInPropSetException {
	    	...
	    	Network.clearNetwork();
	    	Network.buildBaseNode("x0", semantic);
	    	Network.buildBaseNode("x1", semantic);
	    	Network.buildBaseNode("x2", semantic);
	    	Network.buildBaseNode("x3", semantic);
	    	Network.buildBaseNode("x4", semantic);
	    
	    	
	    	
	    	
	    	//Network.removeNode(Network.getNode("x0"));
	    	//Network.removeNode(Network.getNode("x1"));
	    	//Network.removeNode(Network.getNode("x2"));
	    	Network.removeNode(Network.getNode("x3"));
	    	//Network.removeNode(Network.getNode("x4"));
	    	assertNull(Network.nodesIndex.get(3));
	    	
	    	Network.buildBaseNode("x3", semantic);
	    	assertEquals(Network.getNode("x3"),Network.nodesIndex.get(3));
	    	assertEquals(3,Network.getNode("x3").getId());
	    ...
	    @Test
	 	public void testSemanticCreation() throws SemanticNotFoundInNetworkException {
	 	 ...
	 	 public void TestSuperSemantic() throws SemanticNotFoundInNetworkException {
	    	 ...
	    	 assertEquals(superClassesOfD.size(), 3);
	    	...
	    	// check on the super classes of C
	    	 assertEquals(superClassesOfC.size(), 2);
