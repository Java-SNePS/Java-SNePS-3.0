...
public class SnipTest {
	...
	public static void BuildNetwork() throws Exception {
		...
		/**
		 * Create substitutions, FlagNodeSet, FlagNode, PropositionSet, wires,
		 * relations, caseFrames
		 */
		...
		/**
		 * Building propositions & base nodes, adding wires
		 */
		...
		} catch (IllegalIdentifierException | NotAPropositionNodeException | NodeNotFoundInNetworkException e1) {
			assertNotNull(e1.getMessage(), e1);
		...
		} catch (CannotBuildNodeException | EquivalentNodeException | NotAPropositionNodeException
