...
public class SIndexTest {
	...
	public void newSIndex() {
		...
		/**
		 * Creating Variables,
		 * VariableNodes using Variables,
		 * VariableNodeSets,
		 * adding variableNodes in VariableNodeSets
		 */
		 ...
		 * Inserting the bindings in the Substitutions
		 */
		...
		/**
		 * Creating FlaggedNodes, 
		 * FlaggedNodeSets,
		 * Insert the FlaggedNodes in the FlaggedNodeSets
		 */
		...
		assertEquals(5, SIndexHelper.getSize());
	}
