...
public class RCFP implements Serializable {
	 ...
	 * adjustability is to be applied and override the default adjustability of the
	 * relation within a certain case frame.
	 */
	private String adjust;

	/**
	 * The specified limit of the relation in the current RCFP. This limit is to be
	 * applied and override the default limit of the relation within a certain case
	 * frame.
	 */
	private int limit;
	...
	public static void createDefaultProperties() {
		...
		thresh = Network.defineRelationPropertiesForCF(Relation.thresh, "none", 1);
		threshMax = Network.defineRelationPropertiesForCF(Relation.threshMax, "none", 1);

		action = Network.defineRelationPropertiesForCF(Relation.action, "none", 1);
		obj = Network.defineRelationPropertiesForCF(Relation.obj, "none", 1);
		...
		precondition = Network.defineRelationPropertiesForCF(Relation.precondition, "none", 1);
		...
		whenever = Network.defineRelationPropertiesForCF(Relation.whenever, "none", 1);
