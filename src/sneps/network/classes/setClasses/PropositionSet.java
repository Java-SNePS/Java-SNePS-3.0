...
public class PropositionSet implements Serializable {
	 ...
	 *
	 * @param prop proposition to be added to the array of props in this
	 *             PropositionSet
	...
	/**
	 * Constructs a new PropositionSet with an array containing of propositions deep
	 * cloning of the array occurs here.
	 *
	 ...
	 *
	 * @param props the array of props that duplicates should be removed from if
	 *              found
	...
	/**
	 * Checks if a given PropositionSet is equivalent to this. It checks for
	 * equality by comparing the equivalence of the two props arrays.
	 *
	 * @param obj
	 ...
	 *
	 * @param propositionSet the set that should be a superset of this
	 *                       PropositionSet
	 * @return <code>true</code> if this is a subset of propositionSet,
	...
	/**
	 * Performs a union of this PropositionSet and a passed PropositionSet and
	 * returns a new PropositionSet with the union
	 *
	 ...
	 *
	 * @param prop the proposition that shouldn't be present in the returned
	 *             PropositionSet
	 * @return a new PropositionSet not having prop.
	 * @throws NodeNotFoundInPropSetException if prop is not found in this
	 *                                        PropositionSet
	 * @throws NodeNotFoundInNetworkException
	 */
	...
	public PropositionSet removeProps(PropositionSet propSet)
			throws NotAPropositionNodeException, NodeNotFoundInNetworkException {
