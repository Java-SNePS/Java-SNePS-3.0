...
public class Relation implements Serializable {
	...
	public static Relation andAnt, ant, cq, arg, min, max, i, threshMax, thresh, action,guard,property, obj, precondition, act, when,
			whenever, doo, iff, effect, plan, goal, vars, suchthat, elsee, obj1, obj2, obj3, obj4, obj5, obj6, obj7,
			obj8, obj9, obj10,doo1,doo2,doo3,doo4,doo5,doo6,doo7,doo8,doo9,doo10;
	...
	public static void createDefaultRelations() {
		...
		guard = Network.defineRelation("guard", "Proposition", "none", 1);
		property=Network.defineRelation("property", "Proposition", "none", 1);
		...
		*/
		...
		obj = Network.defineRelation("obj", "Proposition", "none", 1);

		obj1 = Network.defineRelation("obj1", "Proposition", "none", 1);
		obj2 = Network.defineRelation("obj2", "Proposition", "none", 1);
		obj3 = Network.defineRelation("obj3", "Proposition", "none", 1);
		obj4 = Network.defineRelation("obj4", "Proposition", "none", 1);
		obj5 = Network.defineRelation("obj5", "Proposition", "none", 1);
		obj6 = Network.defineRelation("obj6", "Proposition", "none", 1);
		obj7 = Network.defineRelation("obj7", "Proposition", "none", 1);
		obj8 = Network.defineRelation("obj8", "Proposition", "none", 1);
		obj9 = Network.defineRelation("obj9", "Proposition", "none", 1);
		obj10 = Network.defineRelation("obj10", "Proposition", "none", 1);
		
		doo1 = Network.defineRelation("do1", "Act", "none", 1);
		doo2 = Network.defineRelation("do2", "Act", "none", 1);
		doo3 = Network.defineRelation("do3", "Act", "none", 1);
		doo4 = Network.defineRelation("do4", "Act", "none", 1);
		doo5 = Network.defineRelation("do5", "Act", "none", 1);
		doo6 = Network.defineRelation("do6", "Act", "none", 1);
		doo7 = Network.defineRelation("do7", "Act", "none", 1);
		doo8 = Network.defineRelation("do8", "Act", "none", 1);
		doo9 = Network.defineRelation("do9", "Act", "none", 1);
		doo10 = Network.defineRelation("do10", "Act", "none", 1);
