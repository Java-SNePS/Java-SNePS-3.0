...
//	private String id;
	...
	/** 
	 * The second constructor of this class that discards some conceptual data to define 
	 * the case frame and only constructs a case frame using a semantic type and a list 
	 * of relations. 
	 * 
	 * @param semantic 
	 *            the name of the semantic class representing the semantic type
