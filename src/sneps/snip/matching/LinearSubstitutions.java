...
public class LinearSubstitutions implements Substitutions {
	...
	/**
	 * Returns the binding witch have mv as its variable node or null if mv is not
	...
	/**
	 * returns a substitutions list consisting of only those bindings whose variable
	 * node are in ns
	 * 
	...
	/**
	 * If mv is an variable node which is bound, then returns the node to which mv
	...
	/**
	 * If the node n is bound to another node return the one bounding it otherwise
	 * return the node it self
	 * 
	 * @param n node
	 * @return node
	 */
	...
	/**
	 * Returns a new substitutions list with the binding of this added to them the
	 * Binding m
	 * 
	 * @param m Binding
	 * @return Substitutions
	...
	/**
	 * Check if the substitutions list s is compatible to this or not two lists are
	 * compatible if ever variable node in both are bound to the same node and ever
	 * node in both are bound to the same variable node
	 * 
	 * @param s substitutions list
	 * @return true or false
	 */
